    ...
    <div className="min-h-screen bg-stone-950 text-white">
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          <div className="max-w-2xl">
            ...
            <h1 className="text-5xl sm:text-6xl font-black text-white leading-tight mb-6">
              Travel smarter,<br />
              <span className="text-amber-400">arrive easier.</span>
            </h1>

            {/* Subtext */}
            <p className="text-gray-400 text-lg leading-relaxed mb-10">
              Book inter-city and cross-border bus tickets online. Choose your seat,<br className="hidden sm:block"/>
              pay with Mobile Money, and travel in Silver or Gold comfort.
            </p>
          </div>
      ...
      <section className="bg-stone-50 py-16 px-4 sm:px-6 lg:px-8 border-b border-stone-100">
        <div className="max-w-6xl mx-auto">
          <div className="mb-10">
            <h2 className="text-3xl font-extrabold text-stone-900 tracking-tight">Popular Routes</h2>
            <p className="text-stone-500 text-sm mt-2">Most booked trips this week</p>
          </div>
      ...
      <section className="bg-stone-50 py-16 px-4 sm:px-6 lg:px-8 border-b border-stone-100">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-extrabold text-stone-900 tracking-tight">Why Travel With TransitHub?</h2>
            <p className="text-stone-500 text-sm mt-2">A modern booking experience built for African travelers</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white border border-stone-100 rounded-2xl p-8 shadow-sm text-center">
              ...
              <h3 className="text-stone-900 font-extrabold text-lg mb-3">Choose Your Seat</h3>
              <p className="text-stone-500 text-sm leading-relaxed">
                Pick your favorite seat from our live interactive seat map before you pay.
              </p>
            </div>
            ...
            <div className="bg-white border border-stone-100 rounded-2xl p-8 shadow-sm text-center">
              ...
              <h3 className="text-stone-900 font-extrabold text-lg mb-3">Secure Payments</h3>
              <p className="text-stone-500 text-sm leading-relaxed">
                Pay with MTN/Orange Mobile Money or Visa/Mastercard — fully secured.
              </p>
            </div>
            ...
            <div className="bg-white border border-stone-100 rounded-2xl p-8 shadow-sm text-center">
              ...
              <h3 className="text-stone-900 font-extrabold text-lg mb-3">Cross-Border Ready</h3>
              <p className="text-stone-500 text-sm leading-relaxed">
                Book international trips with passport verification built into the flow.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-white py-16 px-4 sm:px-6 lg:px-8 border-y border-gray-100">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-extrabold text-stone-900 tracking-tight">Choose Your Comfort Level</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-7">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900">Silver Comfort</h3>
                  <p className="text-gray-500 text-sm">Standard inter-city travel</p>
                </div>
              </div>
              <ul className="space-y-3">
                {['Reclining seats (2+2 layout)', 'Air conditioning', 'Onboard entertainment', '1 stop refreshment break'].map(item => (
            ...
            <div className="bg-white border-2 border-amber-400 rounded-2xl p-7 relative">
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm">Luxury long-distance travel</p>
                </div>
              </div>
              <ul className="space-y-3">
                {['Extra-wide reclining seats (2+1)', 'Individual screens & Wi-Fi', 'Complimentary snacks & drinks', 'Blanket & pillow included'].map(item => (
                  <li key={item} className="flex items-center gap-3 text-gray-600 text-sm">
                    <div className="w-2 h-2 rounded-full bg-amber-500 flex-shrink-0"></div>
                    {item}
                  </li>
      ...
      <footer className="bg-stone-950 border-t border-stone-850 pt-14 pb-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-10 mb-12">
            ...
            <div className="sm:col-span-1">
              ...
              <p className="text-gray-500 text-sm leading-relaxed">
                Inter-city & cross-border transport booking, simplified.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                {[
                  { label: 'Find Trips', to: '/search' },
                  { label: 'My Bookings', to: '/my-trips' },
            ...
            <div>
              ...
              <ul className="space-y-3">
                {['Help Center', 'Cancellation Policy', 'Refund Policy'].map(item => (
                  <li key={item}>
          ...
          <div className="pt-6 border-t border-stone-850">
            <p className="text-gray-600 text-xs">© 2026 TransitHub. All rights reserved.</p>
          </div>
        </div>
      </footer>
